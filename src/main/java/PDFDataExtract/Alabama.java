...
public class Alabama 
{
	...
	public static void alabama()
	{
	    ...
	    {
	    	monthlyRent_Prior = PDFAppConfig.Alabama_monthlyRent_Format1_Prior;
	    	startDate_Prior = PDFAppConfig.Alabama_startDate_Format1_Prior;
	    	startDate_After = PDFAppConfig.Alabama_startDate_Format1_After;
	    }
	    else if(text.contains(AppConfig.PDFFormatConfirmationText))
	    {
	    	monthlyRent_Prior = PDFAppConfig.Alabama_monthlyRent_Format2_Prior;
	    	startDate_Prior = PDFAppConfig.Alabama_startDate_Format2_Prior;
	    	startDate_After = PDFAppConfig.Alabama_startDate_Format2_After;
	    } 
	    else 
	    {
